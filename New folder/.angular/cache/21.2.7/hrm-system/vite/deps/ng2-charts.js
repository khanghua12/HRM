import {
  isPlatformBrowser
} from "./chunk-YR6QOUZB.js";
import "./chunk-SBJYKBCI.js";
import {
  Directive,
  ElementRef,
  Injectable,
...
function debounce(fn, delay2) {
  ...
  return function(...args) {
    if (delay2) {
      ...
      timeout2 = setTimeout(fn, delay2, args);
    } else {
      fn.apply(this, args);
    }
    return delay2;
...
function provideCharts(...configurations) {
  const config = configurations.reduce(merge2, {});
  return {
